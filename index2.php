...
<body>
    ...
    <section>
        ...
        $i = 12;
        $reponse = $bdd->query('SELECT name from serveur LIMIT 12 OFFSET 12');
    ...
    <footer>
        <p class="retourpage">Page précédente <a href="index.php">n°1</a></p>
        <p class="suivantepage">Page suivante <a href="index3.php">n°3</a></p>
    </footer>
